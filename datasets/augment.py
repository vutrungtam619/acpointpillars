...
def db_sample_aug(data_dict, classes, db_sample, sample_groups):
    pts = data_dict['pts']
...
def train_data_aug(data_dict, classes, data_aug_config):
    data_dict = db_sample_aug(
        data_dict=data_dict,
        classes=classes,
        db_sample=data_aug_config['db_sample'],
        sample_groups=data_aug_config['sample_groups']
    )
